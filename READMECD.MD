...
spec:
  ...
  ...
```
Note: The secretName should refer to a Kubernetes Secret that contains your TLS certificate (tls.crt) and private key (tls.key). Ensure this Secret exists in the same namespace as your Ingress resource.
